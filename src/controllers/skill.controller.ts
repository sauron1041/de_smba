...
export class SkillController {
    public skillController = new SkillService();
    public create = async (req: Request, res: Response, next: NextFunction) => {
        const model = req.body;
        model.user_id = req.id;
        try {
            const result = await this.skillController.create(model);
    ...
    public update = async (req: Request, res: Response, next: NextFunction) => {
        ...
        try {
            const result = await this.skillController.update(model, id);
            if (result instanceof Error && result.field)
                return sendResponse(res, result.status, result.message, null, result.field);
            if (result instanceof Error)
                return sendResponse(res, result.status, result.message as string);
    ...
    public delete = async (req: Request, res: Response, next: NextFunction) => {
        const id: number = req.params.id as any;
        try {
            const result = await this.skillController.delete(id);
            if (result instanceof Error)
    ...
    public findById = async (req: Request, res: Response, next: NextFunction) => {
        const id: number = req.params.id as any;
        try {
            const result = await this.skillController.findById(id);
            if (result instanceof Error)
                return sendResponse(res, result.status, result.message);
    ...
    public searchs = async (req: Request, res: Response, next: NextFunction) => {
        ...
        try {
            const result = await this.skillController.searchs(key, pageInt, limitInt, model);
            if (result instanceof Error)
                return sendResponse(res, result.status, result.message);
    ...
    public updatestatus = async (req: Request, res: Response, next: NextFunction) => {
        const id: number = req.params.id as any;
        try {
            const result = await this.skillController.updateStatus(id);
            if (result instanceof Error)
                return sendResponse(res, result.status, result.message);
    ...
    public deleteList = async (req: Request, res: Response, next: NextFunction) => {
        ...
        try {
            const result = await this.skillController.deleteList(listId);
            if (result instanceof Error)
                return sendResponse(res, result.status, result.message);
            return sendResponse(res, 200, message.DELETE_SUCCESS, result);
        } catch (error) {
    ...
    public updateListstatus = async (req: Request, res: Response, next: NextFunction) => {
        ...
        try {
            const result = await this.skillController.updateListStatus(listId, status);
            if (result instanceof Error)
                return sendResponse(res, result.status, result.message);
            return sendResponse(res, 200, message.UPDATE_SUCCESS, result);
        } catch (error) {
